...
package com.livrexpress.barcode.camera;
...
import com.livrexpress.barcode.PlanarYUVLuminanceSource;
import com.livrexpress.barcode.data.Preferences;
...
public final class CameraManager
{
    ...
    public void closeDriver()
    {
        if (camera != null)
        {
            camera.release();
            camera = null;
            // Make sure to clear these each time we close the camera, so that any scanning rect requested by intent is forgotten.
            framingRect = null;
